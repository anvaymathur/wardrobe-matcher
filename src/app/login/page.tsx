...
export default async function LoginPage({
  ...
  return (
    <div className="mx-auto flex w-full max-w-sm flex-col px-4 py-16 sm:px-6 sm:py-20">
      ...
      <form action={login} className="mt-6 flex flex-col gap-3">
        <input
          ...
          className="w-full rounded-md border border-black/15 bg-background text-foreground px-3 py-2.5 text-base outline-none focus:border-foreground dark:border-white/20"
        />
        {error && (
